  ...
  return (
    <>
      ...
      <div className="sidebar__nav-container">
        <Select>
          <SelectTrigger className="sidebar__org-switcher">
            <div className="sidebar__org-trigger-content">
              <Image
          ...
          <SelectContent>
            <SelectGroup>
              <SelectLabel className="sidebar__org-label">
                Organisations
              </SelectLabel>
              <SelectItem className="sidebar__org-item" value="kredi">
                Kredi
              </SelectItem>
              <SelectItem className="sidebar__org-item" value="urgent10k">
                urgent10k
              </SelectItem>
            </SelectGroup>
          </SelectContent>
        ...
        <nav className="sidebar__nav">
          ...
          <Link
            href="/dashboard"
            className={`sidebar__nav-link ${path === "/dashboard" &&
          ...
          >
            ...
            >
              <g clip-path="url(#clip0_94421_635)">
                <path
                  opacity="0.4"
              ...
              <defs>
                <clipPath id="clip0_94421_635">
                  <rect width="16" height="14.2222" fill="white" />
                </clipPath>
              </defs>
            </svg>

            <p className={`sidebar__nav-text ${path !== "/dashboard" && "sidebar__nav-text--inactive"}`}>
              Dashboard
            </p>
          </Link>
          ...
          {/* customers */}
          <div>
            <p className="sidebar__section-header">
              CUSTOMERS
            </p>
            ...
            <div className="sidebar__section-list">
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/users") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/guarantors") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  ...
                  />
                  <path
                    opacity={`${!path?.startsWith("/dashboard/guarantors") && "0.6"}`}
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/guarantors") && "sidebar__nav-text--inactive"}`}>
                  Guarantors
                </p>
              </Link>
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/loans") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_818)">
                    <path
                      opacity="0.4"
                    ...
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/loans") && "0.6"}`}
                  ...
                  <defs>
                    <clipPath id="clip0_94421_818">
                      <rect width="16" height="16" fill="white" />
                    </clipPath>
                  </defs>
                </svg>
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/loans") && "sidebar__nav-text--inactive"}`}>
                  Loans
                </p>
              </Link>
              {/* Decision Models */}
              <Link
                href="/dashboard/decision%20models"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/decision models") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  <path
                    opacity={`${!path?.startsWith("/dashboard/decision models") && "0.6"
                      }`}
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/decision models") && "sidebar__nav-text--inactive"}`}>
                  Decision Models
                </p>
              </Link>
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/savings") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_796)">
                    <path
                      opacity="0.4"
                    ...
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/savings") && "0.6"}`}
                  ...
                  <defs>
                    <clipPath id="clip0_94421_796">
                      <rect width="16" height="14.2222" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/savings") && "sidebar__nav-text--inactive"}`}>
                  Savings
                </p>
              </Link>
              {/* Loan Requests */}
              <Link
                href="/dashboard/loan%20requests"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/loan requests") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/loan requests") && "sidebar__nav-text--inactive"}`}>
                  Loan Requests
                </p>
              </Link>
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/whitelist") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/karma") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_845)">
                    <path
                      opacity="0.4"
                    ...
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/karma") && "0.6"}`}
                  ...
                  <defs>
                    <clipPath id="clip0_94421_845">
                      <rect width="16" height="12.8" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/karma") && "sidebar__nav-text--inactive"}`}>
                  Karma
                </p>
              </Link>
            </div>
          ...
          <div>
            ...
            <div className="sidebar__section-list">
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/organization") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  ...
                  />
                  <path
                    opacity={`${!path?.startsWith("/dashboard/organization") && "0.6"}`}
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/organization") && "sidebar__nav-text--inactive"}`}>
                  Organization
                </p>
              </Link>
              {/* Loan Products */}
              <Link
                href="/dashboard/loan%20products"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/loan products") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  <g clip-path="url(#clip0_94421_805)">
                    <path
                      opacity={`${path !== "/dashboard/loan%20products" && "0.6"}`}
                      d="M17.625 12.7813L12.9 16.5625C12.545 16.8459 12.1042 17.0002 11.65 17H0.5C0.367392 17 0.240215 16.9473 0.146447 16.8536C0.0526784 16.7598 0 16.6326 0 16.5V13.5C0 13.3674 0.0526784 13.2402 0.146447 13.1464C0.240215 13.0527 0.367392 13 0.5 13H2.23125L3.68438 11.8219C4.3392 11.2905 5.15673 11.0004 6 11H11C11.1458 10.9997 11.2898 11.0313 11.4221 11.0926C11.5543 11.1538 11.6716 11.2433 11.7657 11.3546C11.8598 11.4659 11.9284 11.5965 11.9667 11.7371C12.005 11.8778 12.0121 12.0251 11.9875 12.1688C11.9062 12.6594 11.4437 13 10.9469 13H8.5C8.36739 13 8.24021 13.0527 8.14645 13.1464C8.05268 13.2402 8 13.3674 8 13.5C8 13.6326 8.05268 13.7598 8.14645 13.8536C8.24021 13.9473 8.36739 14 8.5 14H12.1969C12.6513 14.0012 13.0924 13.8468 13.4469 13.5625L16.3344 11.2531C16.7219 10.9406 17.2969 10.9188 17.6656 11.2531C17.7744 11.3499 17.8606 11.4693 17.9185 11.6029C17.9763 11.7365 18.0042 11.8811 18.0004 12.0266C17.9965 12.1722 17.9609 12.3151 17.8961 12.4454C17.8312 12.5758 17.7387 12.6904 17.625 12.7813Z"
                      fill="#213F7D"
                    />
                  </g>
                  <g clip-path="url(#clip1_94421_805)">
                    ...
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/loan products") && "0.6"}`}
                      d="M7.67198 7.6273V6.21304H7.125V5.78433H7.67198V4.375H8.44563L9.21436 5.78433H9.7367V4.375H10.328V5.78433H10.875V6.21304H10.328V7.6273H9.55437L8.77579 6.21304H8.2633V7.6273H7.67198ZM8.2633 5.73998V5.78433H8.53926L8.25345 5.20779H8.24852L8.2633 5.73998ZM9.74655 6.8093H9.75641L9.7367 6.29681V6.21304H9.44596L9.46567 6.24261L9.74655 6.8093Z"
                      fill="#213F7D"
                    />
                  </g>
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/loan products") && "sidebar__nav-text--inactive"}`}>
                  Loan Products
                </p>
              </Link>
              {/* Savings Products */}
              <Link
                href="/dashboard/savings%20products"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/savings products") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M9.77415 6.6696L9.77976 6.66579L9.75994 6.59624C9.71637 6.4433 9.56412 6.32759 9.39902 6.34765C9.36778 6.34933 9.29252 6.35924 9.19023 6.38422C9.0741 6.41259 8.91767 6.46167 8.74087 6.54487C8.40555 6.70267 7.9972 6.98314 7.65272 7.47622C7.38773 7.30782 6.97337 7.15784 6.42665 7.2939C6.29067 7.31876 6.17495 7.43283 6.17132 7.59216C6.08104 8.23011 6.30852 8.84738 6.61311 9.35899C6.91339 9.86335 7.29499 10.2758 7.54673 10.5209C7.56261 10.5581 7.58055 10.5939 7.59555 10.6239L7.59581 10.6244C7.61109 10.6549 7.62183 10.6766 7.62833 10.6922C7.63652 10.863 7.64834 11.0075 7.66019 11.1146C7.66629 11.1697 7.67248 11.2156 7.67833 11.2505C7.68124 11.2679 7.68423 11.2835 7.68728 11.2966C7.68877 11.3031 7.69099 11.3121 7.69424 11.3217C7.72466 11.4852 7.88332 11.5873 8.03123 11.5873H8.07935V11.5881L8.09194 11.5865C8.27329 11.5635 8.4135 11.3849 8.36936 11.1958L8.36865 11.1913L8.36499 11.1666C8.36186 11.1447 8.35748 11.112 8.35259 11.0699C8.34373 10.9937 8.33319 10.8866 8.32534 10.7558C8.56217 10.4972 9.20018 9.75679 9.52878 9.10027L9.52879 9.10028L9.5295 9.0988C9.81895 8.49601 9.87602 7.88277 9.86173 7.41677C9.85457 7.18341 9.82949 6.98591 9.80619 6.84363C9.79454 6.77245 9.78333 6.71513 9.7751 6.67433L9.77415 6.6696ZM6.98193 8.07855C6.92097 8.12214 6.8807 8.17844 6.85884 8.23966C6.83699 8.13848 6.82353 8.03683 6.82021 7.9354C6.98566 7.93501 7.11772 7.97419 7.21929 8.02463C7.14084 8.01588 7.05976 8.03343 6.99043 8.0731L6.99018 8.07265L6.98193 8.07855ZM8.89417 8.78795C8.75741 9.0572 8.55621 9.35207 8.35435 9.6132C8.44364 9.0776 8.62876 8.48304 9.0089 7.96328L9.00891 7.96329L9.00953 7.96241C9.11815 7.81052 9.09978 7.60217 8.93823 7.48665C8.82315 7.40436 8.67566 7.39495 8.56069 7.46549C8.77006 7.28693 8.97687 7.18318 9.13941 7.12276C9.20062 7.494 9.20823 8.15929 8.90248 8.7713L8.89417 8.78795ZM8.00887 8.17268C8.1477 7.90645 8.30813 7.7028 8.47062 7.54698C8.4681 7.55025 8.46561 7.55358 8.46317 7.55697C8.17372 7.94341 7.97572 8.36361 7.84149 8.77622C7.86217 8.57284 7.91479 8.36895 8.00887 8.17268Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M4.46006 11.84C4.46006 12.0233 4.61671 12.18 4.80006 12.18C4.98341 12.18 5.14006 12.0233 5.14006 11.84V5.75996C5.14006 5.57661 4.98341 5.41996 4.80006 5.41996C4.61671 5.41996 4.46006 5.57661 4.46006 5.75996V11.84Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M2.86008 11.84C2.86008 12.0233 3.01673 12.18 3.20008 12.18C3.38344 12.18 3.54008 12.0233 3.54008 11.84V5.75996C3.54008 5.57661 3.38344 5.41996 3.20008 5.41996C3.01673 5.41996 2.86008 5.57661 2.86008 5.75996V11.84Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M10.8601 11.84C10.8601 12.0233 11.0167 12.18 11.2001 12.18C11.3834 12.18 11.5401 12.0233 11.5401 11.84V5.75996C11.5401 5.57661 11.3834 5.41996 11.2001 5.41996C11.0167 5.41996 10.8601 5.57661 10.8601 5.75996V11.84Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M12.4601 11.84C12.4601 12.0233 12.6167 12.18 12.8001 12.18C12.9834 12.18 13.1401 12.0233 13.1401 11.84V5.75996C13.1401 5.57661 12.9834 5.41996 12.8001 5.41996C12.6167 5.41996 12.4601 5.57661 12.4601 5.75996V11.84Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M13.5818 5.29997H13.36H2.64004C2.48648 5.29997 2.34567 5.19237 2.31862 5.04569C2.27553 4.88563 2.35048 4.75011 2.4727 4.66863L2.47684 4.66587L2.47691 4.66598L7.83662 1.46615C7.83666 1.46612 7.83671 1.4661 7.83675 1.46607L7.83691 1.46598L7.88817 1.55184C7.96817 1.50372 8.06442 1.50372 8.12817 1.55184L13.5818 5.29997ZM13.5818 5.29997L13.5366 5.24878C13.6335 5.18881 13.7013 5.08325 13.7149 4.97131L13.7156 4.9714V4.95926C13.7156 4.82907 13.6337 4.69696 13.517 4.64602L8.18352 1.46841L13.5818 5.29997ZM12.119 4.61997H3.86586L7.99994 2.14837L12.119 4.61997Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M2.64002 12.98H13.36C13.5434 12.98 13.7 12.8233 13.7 12.64C13.7 12.4566 13.5434 12.3 13.36 12.3H2.64002C2.45667 12.3 2.30002 12.4566 2.30002 12.64C2.30002 12.8233 2.45667 12.98 2.64002 12.98Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${path !== "/dashboard/savings%20products" && "0.6"}`}
                    d="M1.8401 13.78H14.1601C14.3435 13.78 14.5001 13.6233 14.5001 13.44C14.5001 13.2566 14.3435 13.1 14.1601 13.1H1.8401C1.65674 13.1 1.5001 13.2566 1.5001 13.44C1.5001 13.6233 1.65674 13.78 1.8401 13.78Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                  <path
                    opacity={`${!path?.startsWith("/dashboard/savings products") && "0.6"}`}
                    d="M1.04005 14.5799H14.96C15.1434 14.5799 15.3 14.4233 15.3 14.2399C15.3 14.0566 15.1434 13.8999 14.96 13.8999H1.04005C0.856696 13.8999 0.700049 14.0566 0.700049 14.2399C0.700049 14.4233 0.856696 14.5799 1.04005 14.5799Z"
                    fill="#213F7D"
                    stroke="#213F7D"
                    stroke-width="0.2"
                  />
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/savings products") && "sidebar__nav-text--inactive"}`}>
                  Savings Products
                </p>
              </Link>
              {/* Fees and Charges */}
              <Link
                href="/dashboard/fees%20and%20charges"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/fees and charges") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_749)">
                    <path
                      opacity={`${!path?.startsWith("/dashboard/fees and charges") && "0.6"}`}
                  ...
                  <defs>
                    <clipPath id="clip0_94421_749">
                      <rect width="16" height="16" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/fees and charges") && "sidebar__nav-text--inactive"}`}>
                  Fees and Charges
                </p>
              </Link>
              {/*Transactions */}
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/transactions") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  <path
                    opacity={`${!path?.startsWith("/dashboard/transactions") && "0.6"}`}
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/transactions") && "sidebar__nav-text--inactive"}`}>
                  Transactions
                </p>
              </Link>
              {/* Services */}
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/services") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_719)">
                    <path
                      opacity="0.4"
                      d="M4.76289 11.8763C4.27079 11.7741 3.7942 11.608 3.34529 11.382C2.56301 11.4979 1.76397 11.405 1.02915 11.1127C0.608989 10.9443 0.239607 11.4464 0.525982 11.7969C0.960104 12.3261 1.47963 12.7791 2.06308 13.137C3.57369 14.0703 5.44709 14.2436 7.10015 13.6828C7.54342 13.0917 7.83338 12.4 7.94414 11.6695C6.92104 12.0204 5.8228 12.0918 4.76289 11.8763ZM4.33064 7.94413C3.97965 6.92102 3.90826 5.82273 4.12385 4.7628C4.22595 4.27073 4.39207 3.79416 4.61799 3.34526C4.50216 2.56294 4.59505 1.76391 4.88727 1.02903C5.05573 0.608991 4.55354 0.239423 4.20308 0.525739C3.67384 0.95983 3.22094 1.47939 2.86312 2.06291C1.92978 3.57359 1.75644 5.44694 2.31723 7.10001C2.90838 7.5433 3.6001 7.8333 4.33064 7.94413ZM11.6695 8.05582C12.0204 9.07893 12.0918 10.1772 11.8762 11.2372C11.7741 11.7292 11.608 12.2058 11.3821 12.6547C11.4979 13.437 11.405 14.236 11.1128 14.9709C10.9444 15.391 11.4466 15.7605 11.797 15.4742C12.3262 15.0401 12.7791 14.5205 13.137 13.937C14.0703 12.4264 14.2437 10.553 13.6829 8.89994C13.0917 8.45665 12.4 8.16665 11.6695 8.05582ZM15.4741 4.20304C15.04 3.67379 14.5205 3.22083 13.937 2.86289C12.4264 1.92961 10.553 1.75633 8.89994 2.31712C8.45666 2.90824 8.16669 3.59996 8.05595 4.33048C9.07905 3.97955 10.1773 3.90816 11.2372 4.1237C11.7293 4.22581 12.2059 4.39196 12.6548 4.6179C13.4371 4.50195 14.2361 4.59485 14.9709 4.88719C15.3911 5.05564 15.7605 4.55351 15.4741 4.20304Z"
                      fill="#213F7D"
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/services") && "0.6"}`}
                      d="M15.8305 8.56571C15.3056 6.34366 13.4761 4.57078 11.2371 4.12369C10.1772 3.90816 9.07898 3.97955 8.05588 4.33048C8.16961 3.57377 8.47478 2.85866 8.94245 2.25299C9.41012 1.64732 10.0248 1.17118 10.7281 0.869728C11.1442 0.69175 11.0505 0.075416 10.6002 0.030068C9.91897 -0.0371637 9.23132 0.00993299 8.56564 0.169412C6.34374 0.694313 4.5708 2.52378 4.12379 4.76279C3.90819 5.82273 3.97958 6.92101 4.33057 7.94412C3.57385 7.83037 2.85874 7.52517 2.25307 7.05749C1.6474 6.58982 1.17125 5.97516 0.869783 5.27182C0.691806 4.85575 0.0754766 4.94944 0.0300682 5.39976C-0.0371723 6.08095 0.00994484 6.76859 0.169471 7.43424C0.694369 9.65628 2.52382 11.4292 4.76282 11.8762C5.82273 12.0918 6.92098 12.0204 7.94407 11.6695C7.83034 12.4262 7.52517 13.1413 7.0575 13.747C6.58983 14.3526 5.97518 14.8288 5.27185 15.1302C4.85571 15.3082 4.94946 15.9245 5.39978 15.9699C6.08098 16.0371 6.76863 15.99 7.43431 15.8305C9.65621 15.3056 11.4291 13.4762 11.8762 11.2372C12.0918 10.1772 12.0204 9.07893 11.6694 8.05582C12.4261 8.16958 13.1412 8.47477 13.7469 8.94245C14.3526 9.41013 14.8287 10.0248 15.1302 10.7281C15.3081 11.1442 15.9245 11.0505 15.9699 10.6002C16.0371 9.919 15.99 9.23136 15.8305 8.56571ZM7.99998 9.49997C7.7033 9.49997 7.41329 9.412 7.16662 9.24718C6.91994 9.08236 6.72768 8.84809 6.61415 8.574C6.50062 8.29992 6.47091 7.99832 6.52879 7.70734C6.58666 7.41637 6.72952 7.1491 6.9393 6.93932C7.14908 6.72954 7.41635 6.58667 7.70733 6.5288C7.9983 6.47092 8.2999 6.50062 8.57399 6.61415C8.84808 6.72768 9.08235 6.91994 9.24717 7.16662C9.41199 7.41329 9.49996 7.7033 9.49996 7.99997C9.49996 8.39779 9.34192 8.77932 9.06062 9.06062C8.77932 9.34192 8.3978 9.49996 7.99998 9.49997Z"
                      fill="#213F7D"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_94421_719">
                      <rect width="16" height="16" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/services") && "sidebar__nav-text--inactive"}`}>
                  Services
                </p>
              </Link>
              ...
              {/* Service Account */}
              <Link
                href="/dashboard/service%20account"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/service account") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_728)">
                    <path
                      opacity="0.4"
                    ...
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/service account") && "0.6"}`}
                  ...
                  <defs>
                    <clipPath id="clip0_94421_728">
                      <rect width="16" height="12.8" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/service account") && "sidebar__nav-text--inactive"}`}>
                  Service Account
                </p>
              </Link>
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/settlements") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_709)">
                    <path
                      opacity="0.4"
                      d="M13.6 2.4V9.6H7.59995C7.49386 9.6 7.39212 9.64214 7.31711 9.71716C7.24209 9.79217 7.19995 9.89391 7.19995 10V10.8C7.19995 11.3304 6.98924 11.8391 6.61416 12.2142C6.23909 12.5893 5.73038 12.8 5.19995 12.8C4.66952 12.8 4.16081 12.5893 3.78574 12.2142C3.41066 11.8391 3.19995 11.3304 3.19995 10.8V1.625C3.19995 1.19402 3.02875 0.780698 2.724 0.475951C2.41925 0.171205 2.00593 0 1.57495 0L11.2 0C11.8363 0.000661796 12.4463 0.253731 12.8963 0.703675C13.3462 1.15362 13.5993 1.76368 13.6 2.4Z"
                      fill="#213F7D"
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/settlements") && "0.6"}`}
                      d="M1.6 0C1.17565 0 0.768687 0.168571 0.468629 0.468629C0.168571 0.768687 0 1.17565 0 1.6L0 2.8C0 2.90609 0.0421427 3.00783 0.117157 3.08284C0.192172 3.15786 0.293913 3.2 0.4 3.2H3.2V1.625C3.20005 1.19832 3.03228 0.788739 2.73292 0.484701C2.43356 0.180663 2.02663 0.00656431 1.6 0V0ZM4.8 12.8H5.2C5.13525 12.8 5.0715 12.7968 5.0085 12.7908C4.93975 12.7968 4.87025 12.8 4.8 12.8ZM15.6 9.6H7.6C7.49391 9.6 7.39217 9.64214 7.31716 9.71716C7.24214 9.79217 7.2 9.89391 7.2 10V10.8C7.2 11.3304 6.98929 11.8391 6.61421 12.2142C6.23914 12.5893 5.73043 12.8 5.2 12.8H13.2C13.5678 12.8 13.9321 12.7275 14.2719 12.5867C14.6117 12.4459 14.9204 12.2395 15.1804 11.9794C15.4405 11.7192 15.6467 11.4104 15.7873 11.0705C15.9279 10.7306 16.0002 10.3663 16 9.9985C15.9996 9.89267 15.9573 9.79132 15.8823 9.71663C15.8073 9.64194 15.7058 9.6 15.6 9.6Z"
                      fill="#213F7D"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_94421_709">
                      <rect width="16" height="12.8" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/settlements") && "sidebar__nav-text--inactive"}`}>
                  Settlements
                </p>
              </Link>
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/reports") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  ...
                  />
                  <path
                    opacity={`${!path?.startsWith("/dashboard/reports") && "0.6"}`}
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/reports") && "sidebar__nav-text--inactive"}`}>
                  Reports
                </p>
              </Link>
            </div>
          ...
          <div>
            ...
            <div className="sidebar__section-list">
              ...
              <Link
                ...
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/preferences") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_690)">
                    <path
                      opacity="0.4"
                      d="M15.5 2H9V4H15.5C15.6326 4 15.7598 3.94732 15.8536 3.85355C15.9473 3.75979 16 3.63261 16 3.5V2.5C16 2.36739 15.9473 2.24021 15.8536 2.14645C15.7598 2.05268 15.6326 2 15.5 2ZM0.5 4H6V2H0.5C0.367392 2 0.240215 2.05268 0.146447 2.14645C0.0526784 2.24021 0 2.36739 0 2.5L0 3.5C0 3.63261 0.0526784 3.75979 0.146447 3.85355C0.240215 3.94732 0.367392 4 0.5 4ZM0.5 9H10V7H0.5C0.367392 7 0.240215 7.05268 0.146447 7.14645C0.0526784 7.24021 0 7.36739 0 7.5L0 8.5C0 8.63261 0.0526784 8.75979 0.146447 8.85355C0.240215 8.94732 0.367392 9 0.5 9ZM15.5 7H13V9H15.5C15.6326 9 15.7598 8.94732 15.8536 8.85355C15.9473 8.75979 16 8.63261 16 8.5V7.5C16 7.36739 15.9473 7.24021 15.8536 7.14645C15.7598 7.05268 15.6326 7 15.5 7ZM15.5 12H5V14H15.5C15.6326 14 15.7598 13.9473 15.8536 13.8536C15.9473 13.7598 16 13.6326 16 13.5V12.5C16 12.3674 15.9473 12.2402 15.8536 12.1464C15.7598 12.0527 15.6326 12 15.5 12ZM0 12.5V13.5C0 13.6326 0.0526784 13.7598 0.146447 13.8536C0.240215 13.9473 0.367392 14 0.5 14H2V12H0.5C0.367392 12 0.240215 12.0527 0.146447 12.1464C0.0526784 12.2402 0 12.3674 0 12.5H0Z"
                      fill="#213F7D"
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/preferences") && "0.6"}`}
                      d="M8.5 1H7.5C7.36739 1 7.24021 1.05268 7.14645 1.14645C7.05268 1.24021 7 1.36739 7 1.5V4.5C7 4.63261 7.05268 4.75979 7.14645 4.85355C7.24021 4.94732 7.36739 5 7.5 5H8.5C8.63261 5 8.75979 4.94732 8.85355 4.85355C8.94732 4.75979 9 4.63261 9 4.5V1.5C9 1.36739 8.94732 1.24021 8.85355 1.14645C8.75979 1.05268 8.63261 1 8.5 1ZM12.5 6H11.5C11.3674 6 11.2402 6.05268 11.1464 6.14645C11.0527 6.24021 11 6.36739 11 6.5V9.5C11 9.63261 11.0527 9.75979 11.1464 9.85355C11.2402 9.94732 11.3674 10 11.5 10H12.5C12.6326 10 12.7598 9.94732 12.8536 9.85355C12.9473 9.75979 13 9.63261 13 9.5V6.5C13 6.36739 12.9473 6.24021 12.8536 6.14645C12.7598 6.05268 12.6326 6 12.5 6ZM4.5 11H3.5C3.36739 11 3.24021 11.0527 3.14645 11.1464C3.05268 11.2402 3 11.3674 3 11.5V14.5C3 14.6326 3.05268 14.7598 3.14645 14.8536C3.24021 14.9473 3.36739 15 3.5 15H4.5C4.63261 15 4.75979 14.9473 4.85355 14.8536C4.94732 14.7598 5 14.6326 5 14.5V11.5C5 11.3674 4.94732 11.2402 4.85355 11.1464C4.75979 11.0527 4.63261 11 4.5 11Z"
                      fill="#213F7D"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_94421_690">
                      <rect width="16" height="16" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/preferences") && "sidebar__nav-text--inactive"}`}>
                  Preferences
                </p>
              </Link>
              ...
              {/* Fees and Pricing */}
              <Link
                href="/dashboard/fees%20pricing"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/fees pricing") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                ...
                >
                  <g clip-path="url(#clip0_94421_749)">
                    <path
                      opacity={`${!path?.startsWith("/dashboard/fees pricing") && "0.6"}`}
                      d="M0 12.6656V14C0 15.1031 2.6875 16 6 16C9.3125 16 12 15.1031 12 14V12.6656C10.7094 13.575 8.35 14 6 14C3.65 14 1.29062 13.575 0 12.6656ZM10 4C13.3125 4 16 3.10313 16 2C16 0.896875 13.3125 0 10 0C6.6875 0 4 0.896875 4 2C4 3.10313 6.6875 4 10 4ZM0 9.3875V11C0 12.1031 2.6875 13 6 13C9.3125 13 12 12.1031 12 11V9.3875C10.7094 10.45 8.34688 11 6 11C3.65313 11 1.29062 10.45 0 9.3875ZM13 9.73125C14.7906 9.38437 16 8.74063 16 8V6.66563C15.275 7.17812 14.2094 7.52813 13 7.74375V9.73125ZM6 5C2.6875 5 0 6.11875 0 7.5C0 8.88125 2.6875 10 6 10C9.3125 10 12 8.88125 12 7.5C12 6.11875 9.3125 5 6 5ZM12.8531 6.75938C14.7281 6.42188 16 5.75938 16 5V3.66563C14.8906 4.45 12.9844 4.87188 10.9781 4.97188C11.9 5.41875 12.5781 6.01875 12.8531 6.75938Z"
                      fill="#213F7D"
                    />
                  </g>
                ...
                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/fees pricing") && "sidebar__nav-text--inactive"}`}>
                  Fees and Pricing
                </p>
              </Link>
              ...
              {/* Audit Logs */}
              <Link
                href="/dashboard/audit%20logs"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/audit logs") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_94421_680)">
                    <path
                      opacity="0.4"
                      d="M14 2.66663H10.6667C11.3739 2.66663 12.0522 2.94758 12.5523 3.44767C13.0524 3.94777 13.3333 4.62605 13.3333 5.33329H2.66667C2.66667 4.62605 2.94762 3.94777 3.44772 3.44767C3.94781 2.94758 4.62609 2.66663 5.33333 2.66663H2C1.46957 2.66663 0.960859 2.87734 0.585786 3.25241C0.210714 3.62749 0 4.13619 0 4.66663L0 19.3333C0 19.8637 0.210714 20.3724 0.585786 20.7475C0.960859 21.1226 1.46957 21.3333 2 21.3333H14C14.5304 21.3333 15.0391 21.1226 15.4142 20.7475C15.7893 20.3724 16 19.8637 16 19.3333V4.66663C16 4.13619 15.7893 3.62749 15.4142 3.25241C15.0391 2.87734 14.5304 2.66663 14 2.66663ZM4 17.6666C3.80222 17.6666 3.60888 17.608 3.44443 17.4981C3.27998 17.3882 3.15181 17.232 3.07612 17.0493C3.00043 16.8666 2.98063 16.6655 3.01921 16.4715C3.0578 16.2776 3.15304 16.0994 3.29289 15.9595C3.43275 15.8197 3.61093 15.7244 3.80491 15.6858C3.99889 15.6473 4.19996 15.6671 4.38268 15.7427C4.56541 15.8184 4.72159 15.9466 4.83147 16.1111C4.94135 16.2755 5 16.4688 5 16.6666C5.00033 16.798 4.97469 16.9282 4.92455 17.0497C4.87441 17.1712 4.80077 17.2815 4.70784 17.3745C4.61492 17.4674 4.50455 17.541 4.38307 17.5912C4.2616 17.6413 4.13141 17.667 4 17.6666ZM4 13.6666C3.80222 13.6666 3.60888 13.608 3.44443 13.4981C3.27998 13.3882 3.15181 13.232 3.07612 13.0493C3.00043 12.8666 2.98063 12.6655 3.01921 12.4715C3.0578 12.2776 3.15304 12.0994 3.29289 11.9595C3.43275 11.8197 3.61093 11.7244 3.80491 11.6858C3.99889 11.6473 4.19996 11.6671 4.38268 11.7427C4.56541 11.8184 4.72159 11.9466 4.83147 12.1111C4.94135 12.2755 5 12.4688 5 12.6666C5.00033 12.798 4.97469 12.9282 4.92455 13.0497C4.87441 13.1712 4.80077 13.2815 4.70784 13.3745C4.61492 13.4674 4.50455 13.541 4.38307 13.5912C4.2616 13.6413 4.13141 13.667 4 13.6666ZM4 9.66663C3.80222 9.66663 3.60888 9.60798 3.44443 9.4981C3.27998 9.38821 3.15181 9.23204 3.07612 9.04931C3.00043 8.86658 2.98063 8.66552 3.01921 8.47154C3.0578 8.27755 3.15304 8.09937 3.29289 7.95952C3.43275 7.81967 3.61093 7.72443 3.80491 7.68584C3.99889 7.64726 4.19996 7.66706 4.38268 7.74275C4.56541 7.81843 4.72159 7.94661 4.83147 8.11106C4.94135 8.27551 5 8.46884 5 8.66663C5.00033 8.79804 4.97469 8.92823 4.92455 9.0497C4.87441 9.17117 4.80077 9.28154 4.70784 9.37447C4.61492 9.46739 4.50455 9.54104 4.38307 9.59118C4.2616 9.64131 4.13141 9.66696 4 9.66663ZM13.3333 17C13.3333 17.0884 13.2982 17.1732 13.2357 17.2357C13.1732 17.2982 13.0884 17.3333 13 17.3333H7C6.91159 17.3333 6.82681 17.2982 6.7643 17.2357C6.70179 17.1732 6.66667 17.0884 6.66667 17V16.3333C6.66667 16.2449 6.70179 16.1601 6.7643 16.0976C6.82681 16.0351 6.91159 16 7 16H13C13.0884 16 13.1732 16.0351 13.2357 16.0976C13.2982 16.1601 13.3333 16.2449 13.3333 16.3333V17ZM13.3333 13C13.3333 13.0884 13.2982 13.1732 13.2357 13.2357C13.1732 13.2982 13.0884 13.3333 13 13.3333H7C6.91159 13.3333 6.82681 13.2982 6.7643 13.2357C6.70179 13.1732 6.66667 13.0884 6.66667 13V12.3333C6.66667 12.2449 6.70179 12.1601 6.7643 12.0976C6.82681 12.0351 6.91159 12 7 12H13C13.0884 12 13.1732 12.0351 13.2357 12.0976C13.2982 12.1601 13.3333 12.2449 13.3333 12.3333V13ZM13.3333 8.99996C13.3333 9.08837 13.2982 9.17315 13.2357 9.23566C13.1732 9.29817 13.0884 9.33329 13 9.33329H7C6.91159 9.33329 6.82681 9.29817 6.7643 9.23566C6.70179 9.17315 6.66667 9.08837 6.66667 8.99996V8.33329C6.66667 8.24489 6.70179 8.1601 6.7643 8.09759C6.82681 8.03508 6.91159 7.99996 7 7.99996H13C13.0884 7.99996 13.1732 8.03508 13.2357 8.09759C13.2982 8.1601 13.3333 8.24489 13.3333 8.33329V8.99996Z"
                      fill="#213F7D"
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/audit%20logs") && "0.6"}`}
                      d="M3.99996 15.6667C3.80218 15.6667 3.60884 15.7253 3.44439 15.8352C3.27994 15.9451 3.15177 16.1013 3.07608 16.284C3.00039 16.4667 2.98059 16.6678 3.01917 16.8618C3.05776 17.0557 3.153 17.2339 3.29285 17.3738C3.4327 17.5136 3.61089 17.6089 3.80487 17.6475C3.99885 17.686 4.19992 17.6662 4.38264 17.5905C4.56537 17.5149 4.72155 17.3867 4.83143 17.2222C4.94131 17.0578 4.99996 16.8644 4.99996 16.6667C5.00029 16.5353 4.97465 16.4051 4.92451 16.2836C4.87437 16.1621 4.80073 16.0517 4.7078 15.9588C4.61488 15.8659 4.50451 15.7923 4.38303 15.7421C4.26156 15.692 4.13137 15.6663 3.99996 15.6667ZM3.99996 11.6667C3.80218 11.6667 3.60884 11.7253 3.44439 11.8352C3.27994 11.9451 3.15177 12.1013 3.07608 12.284C3.00039 12.4667 2.98059 12.6678 3.01917 12.8618C3.05776 13.0557 3.153 13.2339 3.29285 13.3738C3.4327 13.5136 3.61089 13.6089 3.80487 13.6475C3.99885 13.686 4.19992 13.6662 4.38264 13.5905C4.56537 13.5149 4.72155 13.3867 4.83143 13.2222C4.94131 13.0578 4.99996 12.8644 4.99996 12.6667C5.00029 12.5353 4.97465 12.4051 4.92451 12.2836C4.87437 12.1621 4.80073 12.0517 4.7078 11.9588C4.61488 11.8659 4.50451 11.7923 4.38303 11.7421C4.26156 11.692 4.13137 11.6663 3.99996 11.6667ZM3.99996 7.66667C3.80218 7.66667 3.60884 7.72532 3.44439 7.8352C3.27994 7.94508 3.15177 8.10126 3.07608 8.28398C3.00039 8.46671 2.98059 8.66778 3.01917 8.86176C3.05776 9.05574 3.153 9.23392 3.29285 9.37377C3.4327 9.51363 3.61089 9.60887 3.80487 9.64745C3.99885 9.68604 4.19992 9.66623 4.38264 9.59055C4.56537 9.51486 4.72155 9.38669 4.83143 9.22224C4.94131 9.05779 4.99996 8.86445 4.99996 8.66667C5.00029 8.53525 4.97465 8.40507 4.92451 8.28359C4.87437 8.16212 4.80073 8.05175 4.7078 7.95883C4.61488 7.8659 4.50451 7.79225 4.38303 7.74212C4.26156 7.69198 4.13137 7.66634 3.99996 7.66667ZM10.6666 2.66667C10.6666 1.95942 10.3857 1.28115 9.88558 0.781049C9.38548 0.280952 8.7072 0 7.99996 0C7.29272 0 6.61444 0.280952 6.11434 0.781049C5.61424 1.28115 5.33329 1.95942 5.33329 2.66667C4.62605 2.66667 3.94777 2.94762 3.44767 3.44772C2.94758 3.94781 2.66663 4.62609 2.66663 5.33333H13.3333C13.3333 4.62609 13.0523 3.94781 12.5522 3.44772C12.0521 2.94762 11.3739 2.66667 10.6666 2.66667ZM7.99996 3.66667C7.80218 3.66667 7.60884 3.60802 7.44439 3.49814C7.27994 3.38825 7.15177 3.23208 7.07612 3.04935C7.00039 2.86662 6.98059 2.66556 7.01917 2.47158C7.05776 2.2776 7.153 2.09941 7.29285 1.95956C7.4327 1.81971 7.61089 1.72447 7.80487 1.68588C7.99885 1.6473 8.19992 1.6671 8.38264 1.74279C8.56537 1.81847 8.72155 1.94665 8.83143 2.1111C8.94131 2.27555 8.99996 2.46889 8.99996 2.66667C9.00029 2.79808 8.97465 2.92827 8.92451 3.04974C8.87437 3.17121 8.80072 3.28158 8.7078 3.37451C8.61488 3.46743 8.50451 3.54108 8.38303 3.59122C8.26156 3.64136 8.13137 3.667 7.99996 3.66667Z"
                      fill="#213F7D"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_94421_680">
                      <rect width="16" height="21.3333" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/audit logs") && "sidebar__nav-text--inactive"}`}>
                  Audit Logs
                </p>
              </Link>
              {/* Systems Messages */}
              <Link
                href="/dashboard/systems%20messages"
                className={`sidebar__nav-link ${path?.startsWith("/dashboard/systems messages") &&
                  "sidebar__nav-link--active"
                  }`}
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_96022_118)">
                    <path
                      opacity="0.4"
                      d="M8 2C4.6875 2 2 4.6875 2 8C2 11.3125 4.6875 14 8 14C11.3125 14 14 11.3125 14 8C14 4.6875 11.3125 2 8 2ZM8 3.5C8.69482 3.49885 9.38038 3.65933 10.0025 3.96875L8.78813 5.64094C8.27905 5.45562 7.72095 5.45562 7.21187 5.64094L5.9975 3.96875C6.61962 3.65933 7.30518 3.49885 8 3.5ZM3.5475 8.65625C3.51581 8.43894 3.49994 8.21961 3.5 8C3.49677 6.82214 3.95869 5.69064 4.78531 4.85156L5.99625 6.51844C5.67536 6.94584 5.50128 7.46555 5.5 8C5.5 8.00781 5.50219 8.015 5.50219 8.0225L3.5475 8.65625ZM7.25 12.4375C6.56544 12.3207 5.91702 12.0477 5.3551 11.6396C4.79318 11.2316 4.3329 10.6995 4.01 10.0847L5.96875 9.44875C6.28436 9.88753 6.73403 10.2118 7.25 10.3728V12.4375ZM8 9C7.80222 9 7.60888 8.94135 7.44443 8.83147C7.27998 8.72159 7.15181 8.56541 7.07612 8.38268C7.00043 8.19996 6.98063 7.99889 7.01921 7.80491C7.0578 7.61093 7.15304 7.43275 7.29289 7.29289C7.43275 7.15304 7.61093 7.0578 7.80491 7.01921C7.99889 6.98063 8.19996 7.00043 8.38268 7.07612C8.56541 7.15181 8.72159 7.27998 8.83147 7.44443C8.94135 7.60888 9 7.80222 9 8C9 8.26522 8.89464 8.51957 8.70711 8.70711C8.51957 8.89464 8.26522 9 8 9ZM11.1819 11.1819C10.5227 11.8447 9.6721 12.2839 8.75 12.4375V10.3728C9.26597 10.2118 9.71564 9.88753 10.0312 9.44875L11.99 10.085C11.7778 10.4895 11.5053 10.8593 11.1819 11.1819ZM10.4978 8.02281C10.4978 8.015 10.5 8.00781 10.5 8C10.4987 7.46555 10.3246 6.94584 10.0037 6.51844L11.2147 4.85156C12.0413 5.69064 12.5032 6.82214 12.5 8C12.5 8.22013 12.4841 8.43996 12.4525 8.65781L10.4978 8.02281Z"
                      fill="#213F7D"
                    />
                    <path
                      opacity={`${!path?.startsWith("/dashboard/systems messages") && "0.6"}`}
                      d="M8 7C7.80222 7 7.60888 7.05865 7.44443 7.16853C7.27998 7.27841 7.15181 7.43459 7.07612 7.61732C7.00043 7.80004 6.98063 8.00111 7.01921 8.19509C7.0578 8.38907 7.15304 8.56725 7.29289 8.70711C7.43275 8.84696 7.61093 8.9422 7.80491 8.98079C7.99889 9.01937 8.19996 8.99957 8.38268 8.92388C8.56541 8.84819 8.72159 8.72002 8.83147 8.55557C8.94135 8.39112 9 8.19778 9 8C9 7.73478 8.89464 7.48043 8.70711 7.29289C8.51957 7.10536 8.26522 7 8 7ZM8 0C3.58187 0 0 3.58187 0 8C0 12.4181 3.58187 16 8 16C12.4181 16 16 12.4181 16 8C16 3.58187 12.4181 0 8 0ZM8 14C4.69156 14 2 11.3084 2 8C2 4.69156 4.69156 2 8 2C11.3084 2 14 4.69156 14 8C14 11.3084 11.3084 14 8 14Z"
                      fill="#213F7D"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_96022_118">
                      <rect width="16" height="16" fill="white" />
                    </clipPath>
                  </defs>
                </svg>

                <p className={`sidebar__nav-text ${!path?.startsWith("/dashboard/systems messages") && "sidebar__nav-text--inactive"}`}>
                  Systems Messages
                </p>
              </Link>
            </div>
          ...
          <div className="sidebar__footer">
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_96022_107)">
                  <path
                    opacity="0.4"
