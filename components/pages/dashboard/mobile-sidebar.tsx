...
const MobileSidebar = () => {
  ...
  return (
    <>
      <div className="flex h-14 items-center px-4 shadow-[3px_0px_20px_0px_#0000000A] lg:px-8 lg:py-8">
      ...
      <div className="h-full flex-1 overflow-y-auto">
        <Select>
          <SelectTrigger className="mb-10 mt-7 w-full border-none pl-7 text-[16px] text-secondary shadow-none ring-0 focus-visible:ring-0">
          ...
          <SelectContent>
            <SelectGroup>
              <SelectLabel className="text-sm text-secondary">
                Organisations
              </SelectLabel>
              <SelectItem className="focus:bg-secondary/10" value="kredi">
                Kredi
              </SelectItem>
              <SelectItem className="focus:bg-secondary/10" value="urgent10k">
                urgent10k
              </SelectItem>
            </SelectGroup>
          </SelectContent>
        ...
        <nav className="grid items-start text-sm font-medium">
          ...
          <Link
            ...
            } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
          >
            <svg
              width="16"
              height="16"
            ...
            <p className={`${path !== "/dashboard" && "opacity-40"}`}>
              Dashboard
            </p>
          </Link>
          ...
          {/* customers */}
          <div>
            <p className="mt-5 py-2.5 pl-7 text-xs font-medium text-[#545F7D]">
              CUSTOMERS
            </p>
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <p className={`${path !== "/dashboard/users" && "opacity-40"}`}>
                  Users
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/guarantors" && "opacity-40"}`}
                >
                  Guarantors
                </p>
              </Link>
              ...
              >
                ...
                <p className={`${path !== "/dashboard/loans" && "opacity-40"}`}>
                  Loans
                </p>
              </Link>
              {/* Decision Models */}
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/decision%20models" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                >
                  <path
                    opacity={`${
                      path !== "/dashboard/decision%20models" && "0.6"
                    }`}
                ...
                <p
                  className={`${
                    path !== "/dashboard/decision%20models" && "opacity-40"
                  }`}
                >
                  Decision Models
                </p>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/savings" && "opacity-40"}`}
                >
                  Savings
                </p>
              </Link>
              ...
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/loan%20requests" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                <p
                  className={`${path !== "/dashboard/loan%20requests" && "opacity-40"}`}
                >
                  Loan Requests
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/whitelist" && "opacity-40"}`}
                >
                  Whitelist
                </p>
              </Link>
              ...
              >
                ...
                <p className={`${path !== "/dashboard/karma" && "opacity-40"}`}>
                  Karma
                </p>
              </Link>
            </div>
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/organization" && "opacity-40"}`}
                >
                  Organization
                </p>
              </Link>
              ...
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/loan%20products" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                <p
                  className={`${path !== "/dashboard/loan%20products" && "opacity-40"}`}
                >
                  Loan Products
                </p>
              </Link>
              ...
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/savings%20products" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                <p
                  className={`${path !== "/dashboard/savings%20products" && "opacity-40"}`}
                >
                  Savings Products
                </p>
              </Link>
              ...
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/fees%20and%20charges" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                <p
                  className={`${path !== "/dashboard/fees%20and%20charges" && "opacity-40"}`}
                >
                  Fees and Charges
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/transactions" && "opacity-40"}`}
                >
                  Transactions
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/services" && "opacity-40"}`}
                >
                  Services
                </p>
              </Link>
              ...
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/service%20account" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                <p
                  className={`${path !== "/dashboard/service%20account" && "opacity-40"}`}
                >
                  Service Account
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/settlements" && "opacity-40"}`}
                >
                  Settlements
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/reports" && "opacity-40"}`}
                >
                  Reports
                </p>
              </Link>
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/preferences" && "opacity-40"}`}
                >
                  Preferences
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/fees%20pricing" && "opacity-40"}`}
                >
                  Fees and Pricing
                </p>
              </Link>
              ...
              >
                ...
                <p
                  className={`${path !== "/dashboard/audit%20logs" && "opacity-40"}`}
                >
                  Audit Logs
                </p>
              </Link>
              ...
              <Link
                ...
                className={`flex ${
                  path === "/dashboard/systems%20messages" &&
                  "border-l-[3px] border-l-primary bg-primary/10"
                } items-center gap-2.5 px-7 py-2.5 text-[16px] text-secondary transition-all hover:bg-primary/10`}
              >
                <svg
                ...
                <p
                  className={`${path !== "/dashboard/systems%20messages" && "opacity-40"}`}
                >
                  Systems Messages
                </p>
              </Link>
          ...
          <div className="mt-10 w-full border-t border-t-secondary/40">
            {/* Logout */}
            <Button
              type="button"
              className={`group mb-5 mt-3 flex h-auto w-full items-center justify-start gap-2.5 rounded-none bg-transparent px-7 py-2.5 text-[16px] text-secondary shadow-none transition-all hover:border-l-[3px] hover:border-l-primary hover:bg-primary/10`}
            >
              <svg
                width="16"
                height="16"
              ...
              <p className={`opacity-40 group-hover:opacity-100`}>Logout</p>
            </Button>

            <p className="mb-3 pl-7 text-xs text-secondary">v1.2.0</p>
          </div>
        </nav>
      </div>
    </>
